...
| 08 | [统一立项案模板](08-统一立项案模板.md) | 组合评审 / 外部企划入库 / 阶段 5 总装 | 一案一册同构评审包 | ~2-6 小时（视原文） | 与 01–07 互补；强制同构章节 + Part A 决策区 + 原文口径规则 |

### 08 与 01–07 的关系

- **01–07**：造化坊 5 阶段「边走边产」的分步模板。
- **08**：多案并行评审、桌面/外部企划一次性入库、横向对比时的**统一总装结构**。
- 某案 Go 之后：仍按 [立项流程](../../docs/workflows/06-立项流程.md) 拆到 `projects/{项目名}/00-立项/`，并可回填 01–07；08 文档可继续作为活文档索引。
- 实例目录：[projects/立项组合-202609/](../../projects/立项组合-202609/)

...
| 目录 | 内容 | 读写策略 |
|------|------|---------|
| `docs/` | 文档中心（zh-CN/en/workflows） | 大多只读，目标规划/待办可写 |
...
- `projects/GAME-002/开仙门/` — Godot 4.7 独立游戏
- `projects/interaction-spec-system/` — 交互规范生成工具
- `projects/asset-pipeline/` — 资产生产管线
- `projects/qin-court-audience/` — HTML5 问答游戏
- `projects/xiaohongshu/` — 小红书内容创作

**来源：** CLAUDE.md · docs/zh-CN/04-project-structure.md
**适用 AI：** 全部
